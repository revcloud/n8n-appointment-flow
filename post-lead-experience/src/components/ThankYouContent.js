...
const ThankYouContent = () => {
  ...
  to sell their home quickly, and stress free.
          ...
          <p className="conclusion-paragraph">
            You top offer on your home. They have helped thousands of homeowners who've felt this is the best way to sell their home quickly, and stress free.
          </p>
        </div>
        ...
        <div className="cash-buyers-section">
          <h2 className="cash-buyers-heading">
            Who are these cash buyers, anyway?
          </h2>

          <p className="cash-buyers-paragraph">
